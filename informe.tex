...
Sin embargo, más allá de la forma empaquetada, hay que tener en cuenta que internamente la variable del tipo recibidor es pasada como un parámetro más al método. %link!
